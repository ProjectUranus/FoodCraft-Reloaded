...
import cc.lasmgratel.foodcraftreloaded.common.FruitTypes.*
import cc.lasmgratel.foodcraftreloaded.common.VegetableTypes.*
import cc.lasmgratel.foodcraftreloaded.common.block.*
import cc.lasmgratel.foodcraftreloaded.common.item.*
import cc.lasmgratel.foodcraftreloaded.common.util.Colorable
...
object RegisterHandler {
    ...
    fun registerItems(event: RegistryEvent.Register<Item>) {
        ...
        snack("hamburger", 12)
        // 鱿鱼肉
        snack("squid_meat", 8, "listAllmeatraw")
        // 烤鱿鱼肉
        snack("cooked_squid_meat", 10, "listAllmeatcooked")
        // 鱿鱼丝
        snack("squid_slice", 3)
        // 烤红薯
        ...
        drinkColorables.forEach {
            drink("${it}_juice", 7, it.color, -1, "listAlljuice", "food" + it.toString().capitalize()).apply {
                realTranslationKey = "item.$MODID.$it.name"
                hasSuffix = true
